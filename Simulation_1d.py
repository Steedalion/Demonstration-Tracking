...
mu = [1.0, 0.0]  # each filter is equally likely at the start
...
[x_ca_smooth,_,_,_] = constant_acceleration.rts_smoother(x_ca_filtered, P_a);
...
plot.plot(y,'r.',
          x_ca_filtered[:,0],'b',
          x_ca_smooth[:,0],'k',)
plot.legend(["measurements",'ca_filter', 'x_ca_smooth'])
plot.subplot(1,3,2)
...
plot.legend(["true",'ca_filter','ca_smooth'])
plot.subplot(1,3,3)
